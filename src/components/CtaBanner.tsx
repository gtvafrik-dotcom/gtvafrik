    ...
    return (
        <section className="bg-brand-vibrant-blue text-white px-6 md:px-16 py-16 md:py-20 flex flex-col lg:flex-row items-center justify-between font-prompt gap-12 lg:gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center w-full lg:w-auto">
                ...
                <button className="w-full sm:w-auto bg-brand-yellow text-brand-dark-navy px-8 py-3.5 rounded-md font-bold text-[10px] uppercase tracking-widest shadow-xl hover:brightness-110 whitespace-nowrap transition-all active:scale-95">
                    Book an Appointment
                </button>
            </div>
        </section>
